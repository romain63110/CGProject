...
Cloud::Cloud(const std::string& path, Shader* shader) : Shape(shader) {
...
void Cloud::setupMesh(const std::vector<float>& vertices, const std::vector<unsigned int>& indices) {
...
void Cloud::draw(glm::mat4& model, glm::mat4& view, glm::mat4& projection) {
