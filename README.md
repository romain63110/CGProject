...
The Flight Simulator: Focuses on the physics of movement and camera controls.
The View: Dedicated to the modeling and external rendering of the environment, ensuring the rendering of mountains, water, and their reflective effect.
...
## Technical breakdown
Modeling & Transformation Transformation Pipeline
Advanced Texturing, UV Mapping, Phong Lighting Model
